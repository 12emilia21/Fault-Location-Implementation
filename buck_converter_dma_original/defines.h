...
#define BUFF_SAMPLES     ((uint16_t)28)    // (original 258 pero para que sea efectiva la implementacion) Samples required: 4 resonance periods of the tank (sampling at 200kHz)
